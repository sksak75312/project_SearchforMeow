import{a as l}from"./axios-54ed5feb.js";const r="/project_SearchforMeow/assets/heart-solid1-b7b40f94.svg",o="/project_SearchforMeow/assets/icon_gender-23995dba.svg",c="/project_SearchforMeow/assets/icon_paw-a70165cd.svg",i="/project_SearchforMeow/assets/icon_cat-923b0a7d.svg",n=document.querySelector(".js-recommendCat");document.querySelector(".js-search-area");l.get("https://data.moa.gov.tw/Service/OpenData/TransService.aspx?UnitId=QcbUEzN6E6DL&$filter=animal_kind+like+%E8%B2%93").then(e=>{console.log(e.data),e.data.slice(0,10).forEach(t=>{n.innerHTML+=`
